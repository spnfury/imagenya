...
export default function Home() {
  ...
  return (
    <div className="h-full">
      ...
      >
        <fieldset className="flex h-full grow flex-col gap-8 md:flex-row">
          <div className="max-w-sm bg-gray-100">
            <div className="flex w-full flex-col border-b border-gray-300 p-5 max-md:mt-4">
              ...
              <input
                ...
                type="password"
                value={userAPIKey}
                className="mt-1 rounded bg-gray-200 px-3 py-2 text-xs text-gray-700 placeholder-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300"
                onChange={(e) => saveAPIKey(e.target.value)}
              />
            </div>
                    ...
                    {isFetching ? (
                      ...
                      >
                        ...
                        <div className="mt-2 text-center text-sm">
                          <p className="text-gray-700">{submittedLora.name}</p>
